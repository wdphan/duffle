...
const mutationFn$5 = () => core.disconnect();
...
function useSigner() {
  ...
  const queryClient = useQueryClient();
  React__namespace.useEffect(() => {
    const unwatch = core.watchSigner({
      chainId
...
function useSignTypedData() {
  ...
  const signTypedData = React__namespace.useCallback(args => mutate({
  ...
  const signTypedDataAsync = React__namespace.useCallback(args => mutateAsync({
    domain: (args === null || args === void 0 ? void 0 : args.domain) ?? domain,
    types: (args === null || args === void 0 ? void 0 : args.types) ?? types,
    value: (args === null || args === void 0 ? void 0 : args.value) ?? value
...
function useContractRead() {
  ...
  return useQuery(queryKey_, queryFn$a({
    ...
    select(data) {
      const result = abi && functionName ? core.parseContractResult({
        // TODO: Remove cast and still support `Narrow<TAbi>`
        abi: abi,
        data,
        functionName
  ...
  return useQuery(queryKey_, queryFn$9({
    ...
    select(data) {
      const result = data.map((data, i) => {
        ...
        return abi && functionName ? core.parseContractResult({
          abi,
          functionName,
          data
        }) : data;
...
Object.defineProperty(exports, 'erc4626ABI', {
  enumerable: true,
  get: function () { return core.erc4626ABI; }
});
